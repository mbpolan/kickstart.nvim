...
do
  ...
  vim.opt.tabstop = 4        -- Tab wygląda jak 4 spacje
  vim.opt.shiftwidth = 4     -- wcięcie ma 4 spacje
  vim.opt.softtabstop = 4    -- Tab podczas pisania zachowuje się jak 4 spacje
...
do
  ...
  -- Open Neo-tree whenever a new tab is created
